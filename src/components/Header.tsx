...
export function Header() {
  ...
  return (
    <header style={{ flex: 'none', height: 60, background: '#FEFEF1', borderBottom: '1px solid rgba(0,0,0,.14)', display: 'flex', alignItems: 'center', gap: 14, padding: '0 20px' }}>
      <div style={{ display: 'flex', alignItems: 'baseline', gap: 11 }}>
        <span style={{ fontFamily: "'ALT Gumbo',serif", fontSize: 19, letterSpacing: '-.01em' }}>{title}</span>
        <span style={{ fontFamily: "'Geist Mono',monospace", fontSize: 9.5, letterSpacing: '.14em', textTransform: 'uppercase', color: 'rgba(0,0,0,.42)' }}>{sub}</span>
      </div>
      ...
      <div style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 7 }}>
        ...
        <button
          ...
          style={{ display: 'inline-flex', alignItems: 'center', gap: 8, border: '1px solid rgba(0,0,0,.2)', background: '#FEFEF1', borderRadius: 999, padding: '8px 14px', fontFamily: "'Geist Mono',monospace", fontSize: 10, letterSpacing: '.12em', textTransform: 'uppercase', cursor: 'pointer' }}
        >
          <AskSquare />
          Ask Incenso
        </button>
        <button
          ...
          style={{ position: 'relative', width: 36, height: 36, borderRadius: 999, border: '1px solid rgba(0,0,0,.2)', background: '#FEFEF1', display: 'grid', placeItems: 'center', cursor: 'pointer', color: '#000' }}
